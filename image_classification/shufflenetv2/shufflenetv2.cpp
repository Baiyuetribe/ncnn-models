...
int main(int argc, char **argv)
{
    ...
    net.load_param("models/resnet18.param"); // 模型加载
    net.load_model("models/resnet18.bin");

    ncnn::Mat in = ncnn::Mat::from_pixels_resize(m.data, ncnn::Mat::PIXEL_BGR2RGB, m.cols, m.rows, 224, 224); // 入口RGB格式 shape (3 x H x W), where H and W are expected to be at least 224.
